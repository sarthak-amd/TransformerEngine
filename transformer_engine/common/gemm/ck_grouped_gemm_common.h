...
public:
    ...
    using HostArgs = ck_tile::GroupedGemmHostArgs<0>;
...
#define DECL_CK_GG_RUNNER_EXTERN(AType, BType, CType, ALayout, BLayout, CLayout, TileCfg, MemOp)        \
        extern template class GroupedGemmRunner<AType, BType, CType, ALayout, BLayout, CLayout, TileCfg, MemOp, float>;

#define DECL_CK_GG_RUNNER(AType, BType, CType, ALayout, BLayout, CLayout, TileCfg, MemOp)               \
        template class GroupedGemmRunner<AType, BType, CType, ALayout, BLayout, CLayout, TileCfg, MemOp, float>;
...
// FP16 * FP16 = FP16
APPLY_CK_GG_ALL_LAYOUT(DECL_CK_GG_RUNNER_EXTERN, ck_tile::half_t, ck_tile::half_t, ck_tile::half_t, TileCfg_256x256x64, ck_tile::memory_operation_enum::set)
